...
(function () {
    ...
    if (
        ((p = "https://js.stripe.com"),
            ...
            (j = !!/stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0)),
        ...
        g &&
        ((n = document.querySelectorAll('script[src^="' + p + '"]')), n.length || console.warn("It looks like Stripe.js is not being loaded from https://js.stripe.com. Stripe does not support serving Stripe.js from your own domain.")),
            (a = (function () {
                function a() {
                ...
                return (
                    (a.version = 2),
                        ...
                        (a.setPublishableKey = function (b) {
                            var c, d;
                            if (((a.key = b), a.utils.validateProtocol(a.key), (d = /^pk_test_/.test(a.key)), i && d && !a.acknowledgeIE9Deprecation))
                                throw (
                                    ((c =
                        ...
                        (a.trackPerf = !1),
                        (a._isChannel = "#__stripe_transport__" === ("undefined" != typeof window && null !== window ? window.location.hash : void 0)),
                        ...
                        (a._finalTransport = "undefined" != typeof window && null !== window && "XMLHttpRequest" in window && "withCredentials" in new XMLHttpRequest() ? "cors" : "jsonp"),
                        (a._transport = a._isChannel || a._isSafeDomain ? a._finalTransport : "iframe"),
                        (a._fallBackToOldStripeJsTechniques = function (a) {
                        ...
                        (a._iframeChannelComplete = function (b) {
                            ...
                            for (
                                ...
                                "failure" === this._iframeChannelStatus && this._fallBackToOldStripeJsTechniques(),
                        ...
                        (a._rawRequest = function (b, c) {
                            ...
                            if (
                                (b.data || (b.data = {}),
                                    (e = "POST" === b.method && "object" == typeof (null != (f = b.data) ? f.card : void 0)),
                                c || (null != b.data.payment_user_agent ? this._isChannel || (b.data.payment_user_agent = "" + b.data.payment_user_agent + " (" + a.stripejs_ua + ")") : (b.data.payment_user_agent = a.stripejs_ua)),
                        ...
                        (a.reportError = function (b, c) {
                            ...
                            return (
                                "console" in window && "warn" in window.console,
                                    ...
                                    (new Image().src =
                                        "https://q.stripe.com?event=stripejs-error&type=" + encodeURIComponent(b) + (c ? "&timing=" + c : "") + "&key=" + a.key + "&timestamp=" + d + "&payment_user_agent=" + encodeURIComponent(a.stripejs_ua))
                            );
                        }),
                                        ...
                                        return function (e, f) {
                                            ...
                                            return (
                                                (j = null != (k = b.tokenType) ? k : "unknown"),
                                                    ...
                                                    (i = { event: "rum.stripejs", tokenType: j, url: b.url, status: f, start: d, end: g, resourceTiming: h }),
                                                    a.logRUM(i)
                                            );
                                        };
                                    })(this)),
                        ...
                        (a.complete = function (b, c) {
                            return function (d, e, f) {
                                if ("success" !== d) return a.reportError("Complete500-" + d), "function" == typeof b ? b(500, { error: { code: d, type: d, message: c } }) : void 0;
                            };
                        }),
                        (a._iframeBaseUrl = h),
                        ...
                        (a._channelListener = function (b, c) {
                            ...
                            if ("string" == typeof b) {
                                ...
                                if (((d = g.data.card), (f = g.headers["Accept-Language"]), (h = g.headers["Stripe-Account"]), d))
                                    return (
                                        a.setPublishableKey(g.data.key),
                                        f && a.setLanguage(f),
                                        null != g.endpoint && a._validateEndpoint(g.endpoint) && (a.endpoint = g.endpoint),
        ...
        if (3 !== this.Stripe.version)
            return !g || this.Stripe.isDoubleLoaded || this.Stripe.earlyError || console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page."), void (this.Stripe.isDoubleLoaded = !0);
        ...
        this.Stripe = a,
            ...
            this.Stripe.card = (function (b) {
                ...
                return (
                    t(c, b),
                        (c.tokenName = "card"),
                        (c.whitelistedAttrs = ["number", "cvc", "exp", "exp_month", "exp_year", "name", "address_line1", "address_line2", "address_city", "address_state", "address_zip", "address_country", "currency"]),
                        (c.createToken = function (b, d, e) {
                            var g, h, i;
                            if ((null == d && (d = {}), a.token.validate(b, "card"), "function" == typeof d ? ((e = d), (d = {})) : "object" != typeof d && ((g = parseInt(d, 10)), (d = {}), g > 0 && (d.amount = g)), b._fields && b.createToken))
                        ...
                        (c.validateExpiry = function (b, c) {
                            ...
                            return (
                                ...
                                1 <= f &&
                                f <= 12 &&
                                (2 === c.length && (c = c < 70 ? "20" + c : "19" + c), 4 === c.length && ((e = new Date(c, f)), (d = new Date()), e.setMonth(e.getMonth() - 1), e.setMonth(e.getMonth() + 1, 1), e > d))
                            );
                        }),
            ...
            this.Stripe.bankAccount = (function (b) {
                ...
                return (
                    t(c, b),
                        ...
                        (c.whitelistedAttrs = ["country", "currency", "routing_number", "account_number", "name", "account_holder_type", "account_holder_name"]),
                        (c.createToken = function (b, d, e) {
                                    ...
                                    return g >= 400 && g < 500
                                        ...
                                        : 200 === g && e(b, h)
                                            ...
                                            : (200 === g && d(b, h) && "function" == typeof f && f(g, h),
                                                500 === g && 2 * a._activePolls[b].interval <= a._maxPollInterval ? (a._activePolls[b].interval *= 2) : g >= 200 && g < 500 && (a._activePolls[b].interval = a._defaultPollInterval),
            ...
            this.Stripe.bitcoinReceiver = (function (b) {
                ...
                return (
                    t(c, b),
                        (c._whitelistedAttrs = ["amount", "currency", "email", "description"]),
                    ...
                    t(c, b),
                        ...
                        (c.createThreeDSecure = function (a, b) {
                            ...
                            return (
                                ...
                                (c.card = { number: a.three_d_secure.card.number, cvc: a.three_d_secure.card.cvc, exp_month: a.three_d_secure.card.exp_month, exp_year: a.three_d_secure.card.exp_year }),
                                (null != (f = a.owner) ? f.address : void 0) && (c.owner || (c.owner = {}), (d = c.owner).address || (d.address = a.owner.address)),
                                    this.create(
                                        c,
                                        (function (c) {
                                            return function (d, e) {
                                                var f;
                                                return 200 === d ? ((f = { type: "three_d_secure", amount: a.amount, currency: e.currency, three_d_secure: { card: e.id }, redirect: { return_url: a.redirect.return_url } }), c.create(f, b)) : [d, e];
                                            };
                                        })(this)
                                    )
                            );
                        ...
                        (b.createIframe = function (b, c, d) {
                            ...
                            return (
                                (e = function (b, c) {
                                    ...
                                    (f = new a.easyXDM.Socket({ swf: "" + a._iframeBaseUrl + "/v2/stripexdm.swf", remote: b, onMessage: e, container: c })),
                                    null
                            );
                        }),
                        b
                        ...
                        (b.checkAvailability = function (b) {
                            ...
                            return this._isOverHTTPS()
                                ? (d = /^pk_test_/.test(a.key || a.publishableKey))
                                    ? void b(null != (e = window.ApplePaySession) ? e.canMakePayments() : void 0)
                                    : (null != (f = window.ApplePaySession) ? f.canMakePayments() : void 0)
                                        ? ((c = this.stripeAccount ? "merchant." + window.location.hostname + "." + this.stripeAccount + ".stripe" : "merchant." + window.location.hostname + ".stripe"),
                                            ApplePaySession.canMakePaymentsWithActiveCard(c).then(function (a) {
                                                return b(a);
                                            }))
                                        : void b(!1)
                                : (console.warn("To use Apple Pay, you must serve your page over HTTPS."), void b(!1));
                        }),
            ...
            e = ["createToken", "getToken", "cardType", "validateExpiry", "validateCVC", "validateCardNumber"],
            q = 0,
            r = e.length;
        q < r;
        q++
    ...
    if (((this.Stripe.stripejs_ua = "stripe.js/6c4e062"), !this.Stripe._isChannel && true))
        try {
            (c = []),
            ...
            window.addEventListener(
                ...
                function (b) {
                    ...
                    if (null == a.StripeV3 && !a.isDoubleLoaded) {
                        ...
                        if ("m2" === (null != d ? d.originatingScript : void 0) && /stripe\.com$/.test(b.origin)) {
                            for (a.__mids = { guid: d.payload.guid, sid: d.payload.sid, muid: d.payload.muid }, h = a.utils.getSessionID(), g = a.utils.getMerchantID(), i = []; c.length; ) (e = c.shift()), i.push(e(h, g));
                            return i;
                        }
                    }
                },
                ...
                (b = function () {
                    ...
                    try {
                        ...
                        try {
                            if (((k = document.querySelector("meta[name=referrer]")), null != k))
                                switch ((m = null != (v = k.content) ? v.toLowerCase() : void 0)) {
                                    case "origin":
                                    case "strict-origin":
                        ...
                        (g = /checkout\.stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0)),
                            (d = { referrer: document.referrer, title: document.title, url: t, muid: a.utils.getMerchantID(), sid: a.utils.getSessionID(), version: 6, preview: j && !g }),
                        null != m && (d.metaReferrerPolicy = m),
                            (f = "#");
                        for (n in d) (u = d[n]), (f += "" + n + "=" + encodeURIComponent(u) + "&");
                        (i = document.createElement("iframe")),
                            (i.src = "https://js.stripe.com/v2/m/outer.html" + f),
                            (i.style.cssText = "width: 1px !important; height: 1px !important;\nposition: fixed !important; visibility: hidden !important;\npointer-events: none !important"),
                            ...
                            (s = (function (b) {
                                return function (b) {
                                    var d;
                                    return a.__mids
                                        ? ((b.sid = a.utils.getSessionID()), (b.muid = a.utils.getMerchantID()), r(b))
                                        : ((d = function (a, c) {
                            ...
                            setInterval(function () {
                                var a;
                                if (((a = window.location.href), a !== o)) return s({ action: "ping", referrer: o, url: a, title: document.title, version: 6 }), (o = a);
                            }, 5e3),
                            s({ action: "ping", referrer: o, url: window.location.href, title: document.title, v2: 2, version: 6 });
                    } catch (w) {
            ...
            "function" == typeof window.addEventListener && window.addEventListener("load", b),
                setTimeout(b, 5e3);
        } catch (u) {
            d = u;
        }
    try {
        ...
        document.addEventListener("paste", function (b) {
            ...
            try {
                if (
                    ((c = { "cc-csc": "cvc", "cc-exp-month": "exp", "cc-exp-year": "exp", "cc-number": "number", email: "email", "postal-code": "zip", zip: "zip" }),
                        (d = c[b.target.autocomplete] || a.utils.typeOfString(b.clipboardData.getData("text/plain"))))
                )
                    return (m[d] = !0);
            } catch (e) {
                b = e;
    ...
    "undefined" != typeof module && null !== module && (module.exports = this.Stripe),
    "function" == typeof define &&
    define("stripe", [], (function (a) {
        return function () {
            return a.Stripe;
        };
    })(this));
    ...
    function () {
        ...
        !(function (a, b, c, d, e, f) {
            ...
            function s(c) {
                p(w) && r();
                var e;
                w ? (e = b.createElement('<iframe name="' + c.props.name + '"/>')) : ((e = b.createElement("IFRAME")), (e.name = c.props.name)),
                    (e.id = e.name = c.props.name),
                    e.setAttribute("aria-hidden", "true"),
                    delete c.props.name,
                "string" == typeof c.container && (c.container = b.getElementById(c.container)),
                c.container || (q(e.style, { position: "absolute", top: "-2000px", left: "0px" }), (c.container = b.body));
                var f = c.props.src;
            ...
            function u(a) {
                for (
                    ...
                    (b = a[d]), q(b, c, !0), 0 !== d && (b.down = a[d - 1]), d !== e - 1 && (b.up = a[d + 1]);
                return b;
            }
            function v(a) {
            ...
            q(H, { version: "2.4.19.3", query: O, stack: {}, apply: q, getJSONObject: P, whenReady: j }),
                ...
                (H.stack.FlashTransport = function (a) {
                    ...
                    function g(c) {
                        ...
                        H.Fn.set("flash_loaded" + c.replace(/[\-.]/g, "_"), function () {
                            ...
                            a.swfContainer
                                ? (t = "string" == typeof a.swfContainer ? b.getElementById(a.swfContainer) : a.swfContainer)
                                : ((t = b.createElement("div")),
                                    q(t.style, y && a.swfNoThrottle ? { height: "20px", width: "20px", position: "fixed", right: 0, top: 0 } : { height: "1px", width: "1px", position: "absolute", overflow: "hidden", right: 0, top: 0 }),
                            ...
                            var b = k(a.swf),
                                f = function () {
                                    (H.stack.FlashTransport[b].init = !0),
                                        ...
                                        r.createChannel(a.channel, a.secret, m(a.remote), a.isHost),
                                    a.isHost &&
                                    (y && a.swfNoThrottle && q(a.props, { position: "fixed", right: 0, top: 0, height: "20px", width: "20px" }),
                                        q(a.props, { src: o(a.remote, { xdm_e: m(c.href), xdm_c: a.channel, xdm_p: 6, xdm_s: a.secret }), name: I + a.channel + "_provider" }),
                                        (i = s(a)));
                                };
                        ...
                        onDOMReady: function () {
                            if (((k = m(b.remote)), b.isHost)) {
                                var e = function (c) {
                                    ...
                                    ((i = "postMessage" in h.contentWindow ? h.contentWindow : h.contentWindow.document),
                                        A(a, "message", e),
                                        z(a, "message", f),
                                        d(function () {
                                            g.up.callback(!0);
                                ...
                                z(a, "message", f),
                                    (i = "postMessage" in a.parent ? a.parent : a.parent.document),
                    ...
                    return (c = {
                        ...
                        outgoing: function (d, e, g) {
                            ...
                            if (m) {
                                ...
                                for (; (i = j.shift()); ) h.push({ data: j.length + "_" + i, origin: e, callback: 0 === j.length ? g : null });
                ...
                for (
                    i = (function (a) {
                        return function (b) {
                            var c;
                            return (
                                (c = (null != b ? b.error : void 0) || { message: "Something went wrong validating your Apple Pay Session." }),
                        ...
                        k = null != (n = this.paymentRequest.shippingMethods) ? n[0] : void 0,
                        this.session = g || new ApplePaySession(1, this.paymentRequest),
                        j = (function (a) {
                            return function (b) {
                                return Object.defineProperty(a, b, {
                                    set: function (a) {
                                        if ("onpaymentauthorized" === b || "onvalidatemerchant" === b)
                                            throw new Error("Stripe handles this callback for you; you shouldn't set this property yourself. For more help, see https://stripe.com/docs/apple-pay/web#apple-merchant-validation");
                        ...
                        o = ["oncancel", "onpaymentauthorized", "onpaymentmethodselected", "onshippingcontactselected", "onshippingmethodselected", "onvalidatemerchant"],
                        l = 0,
                        m = o.length;
                    l < m;
                    l++
                            ...
                            return function (c) {
                                ...
                                return (
                                    (d = {
                                        ...
                                        data: { key: Stripe.key || Stripe.publishableKey, validation_url: c.validationURL, domain_name: window.location.hostname, display_name: a.total.label },
                        ...
                        (function (e) {
                            return function (g) {
                                ...
                                return null != e._stripeSkipTokenizationForDemo
                                    ? void e.session.completePayment(ApplePaySession.STATUS_SUCCESS)
                                    : ((l = g.payment),
                                    "simulated identifier" === l.token.transactionIdentifier.toLowerCase() &&
                                    ((h = "4242424242424242"),
                                        (j = a.currencyCode.toLowerCase()),
                                        (i = Stripe.utils.formatAmountWithCurrency(a.total.amount, j)),
                                        (m = Math.random().toString(36).slice(-10)),
                                        (l.token.transactionIdentifier = ["ApplePayStubs", h, i, j, m].join("~")),
                                        ...
                                        Stripe.applePay.createToken(l, function (g, h) {
                                            ...
                                            if (
                                                ...
                                                c.call(i, "postalAddress") >= 0 && (null === (n = l.billingContact.countryCode) || void 0 === n || "" === n)))
                                            )
                                                return (
                                                    (new Image().src = "https://q.stripe.com/?event=stripejs-error&type=ApplePayInvalidCountry&" + Stripe.utils.serialize(l.billingContact)),
                                                        void e.session.completePayment(ApplePaySession.STATUS_INVALID_BILLING_POSTAL_ADDRESS)
                                                );
                                            if (null != l.shippingContact) {
                                                if (
                                                    ((l.shippingContact = d(l.shippingContact)),
                                                        (m = a.requiredShippingContactFields || []),
                                                    c.call(m, "postalAddress") >= 0 && (null === (o = l.shippingContact.countryCode) || void 0 === o || "" === o))
                                                )
                                                    return (
                                                        (new Image().src = "https://q.stripe.com/?event=stripejs-error&type=ApplePayInvalidCountry&" + Stripe.utils.serialize(l.shippingContact)),
                                                            void e.session.completePayment(ApplePaySession.STATUS_INVALID_SHIPPING_POSTAL_ADDRESS)
                                                    );
                                            ...
                                            return b(j, function (a) {
                                                ...
                                                a === ApplePaySession.STATUS_INVALID_SHIPPING_POSTAL_ADDRESS ||
                ...
                (e = function (a) {
                    ...
                    (d = function (a) {
                        ...
                        return (
                            ...
                            ((b = null != (f = a.country) && "function" == typeof f.toLowerCase && "function" == typeof (d = f.toLowerCase()).replace ? d.replace(/[^a-z]+/g, "") : void 0), (a.countryCode = c[b])),
                                a
                        );
                    }),
            ...
            return (
                (c = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g),
                    ...
                    (b.paramsFromForm = function (b, c) {
                        ...
                        for (null == c && (c = []), b.jquery && (b = b[0]), f = b.getElementsByTagName("input"), h = b.getElementsByTagName("select"), i = {}, j = 0, l = f.length; j < l; j++)
                            (e = f[j]), (d = this.underscore(e.getAttribute("data-stripe"))), a.call(c, d) < 0 || (i[d] = e.value);
                    ...
                    (b.validateProtocol = function (a) {
                        ...
                        if (a && "string" == typeof a)
                            return /_live_/g.test(a) && "https:" !== window.location.protocol && null != (null != (b = window.console) ? b.warn : void 0)
                                ? window.console.warn(
                    ...
                    (b.parseExpString = function (a) {
                        ...
                        for (
                            ...
                            (e = f[b]), (d = parseInt(e)), isNaN(d) && g("" + f + " is not a number. "), d < 1 && g("" + d + " is less than one. "), (f[b] = d);
                    ...
                    (b.formatAmountWithCurrency = function (b, c) {
                        ...
                        return (
                            (d = parseFloat(b)),
                                (e = ["bif", "clp", "djf", "gnf", "jpy", "kmf", "krw", "mga", "pyg", "rwf", "vnd", "vuv", "xaf", "xof", "xpf"]),
                                (f = c.toLowerCase()),
                    ...
                    (b.setCookie = function (a, b, c) {
                        ...
                        return (
                            ...
                            null == c.path && (c.path = "/"),
                                ...
                                (d = "" + encodeURIComponent(a) + "=" + b + ";expires=" + e.toGMTString() + ";path=" + c.path + ";SameSite=Lax"),
                    ...
                    (b.getMerchantID = function () {
                        ...
                        try {
                            return (
                                (b = this.determineId(this.getCookie("__stripe_mid"), (null != (c = Stripe.__mids) ? c.muid : void 0) || "NA")),
                                this.isServerGeneratedId(b) && this.setCookie("__stripe_mid", b, { domain: "." + document.location.hostname }),
                                    b
                            );
                        } catch (d) {
                            return (a = d), "NA";
                    ...
                    (b.getSessionID = function () {
                        ...
                        try {
                            return (
                                (b = this.determineId(this.getCookie("__stripe_sid"), (null != (d = Stripe.__mids) ? d.sid : void 0) || "NA")),
                                this.isServerGeneratedId(b) && ((c = { domain: "." + document.location.hostname, expiresIn: 18e5 }), this.setCookie("__stripe_sid", b, c)),
                                    b
                            );
                        } catch (e) {
                            return (a = e), "NA";
                    ...
                    (b.addAdditionalParams = function (a) {
                        var b;
                        if ((null == a.guid && (a.guid = "EMPTY"), null == a.muid && (a.muid = "EMPTY"), null == a.sid && (a.sid = "EMPTY"), true))
                            try {
                    ...
                    (d = new RegExp("^(99999|A9A 9A9|AA9A 9AA|A9A 9AA|A9 9AA|A99 9AA|AA9 9AA|AA99 9AA)$".replace(/A/g, "[a-zA-Z]").replace(/9/g, "\\d").replace(/\s+/g, "\\s*"))),
    ...
    function () {
        ...
        (b = new Date().getTime()),
            (a = !1),
        this.Stripe.isDoubleLoaded ||
        (this.Stripe.ajaxJSONP = function (d) {
            var e, f, g, h, i, j, k, l;
            return (
                null == d && (d = {}),
                    (g = "sjsonp" + ++b),
                    ...
                    (e = function (a) {
                        var b;
                        return null == a && (a = "abort"), clearTimeout(f), null != (b = j.parentNode) && b.removeChild(j), g in window && (window[g] = function () {}), "function" == typeof d.complete ? d.complete(a, l, d) : void 0;
                    }),
                    (l = { abort: e }),
                    null == a
                        ? void l.abort()
                        : ((j.onerror = function () {
                            ...
                            (k = (d.headers || {})["Stripe-Account"]),
                        d.data || (d.data = {}),
                            (d.data.callback = g),
                        d.method && (d.data._method = d.method),
                        i && (d.data._accept_language = i),
                        k && (d.data._stripe_account = k),
                            (j.src = d.url + "?" + Stripe.utils.serialize(d.data)),
    ...
    function () {
        var a,
            ...
            j = {}.hasOwnProperty;
        this.Stripe.isDoubleLoaded ||
        ((b = { contentType: "application/x-www-form-urlencoded", accept: { json: "application/json" } }),
            (g = /^(20\d|1223)$/),
                ...
                return function () {
                    return a._aborted
                        ...
                        : a.request && 4 === a.request.readyState
                            ? ((a.request.onreadystatechange = function () {}), 0 === a.request.status ? c(a.request, "empty_response") : g.test(a.request.status) ? b(a.request, a.request.status) : b(a.request, a.request.status))
                            : void 0;
                };
            }),
            (h = function (a, c) {
                ...
                return (
                    ...
                    this._completeHandlers.push(function () {
                        ...
                        (d = (function (a) {
                            return function (b, c) {
                                var d, e, g;
                                if (((g = b.responseText), (e = void 0), g && g.length && c !== f))
                                    try {
    ...
    function () {
        ...
        ((a = function (a) {
                ...
                (this.options = a),
                    ...
                    (this.iframeTimeout = setTimeout(function () {
                        return (
                            ...
                            Stripe._iframePendingRequests[a.requestId] && (Stripe.request(Stripe._iframePendingRequests[a.requestId], !0), delete Stripe._iframePendingRequests[a.requestId]),
            ...
            this.Stripe._isChannel
                ? (Stripe._socket = new c.Socket({ swf: "" + Stripe._iframeBaseUrl + "/v2/stripexdm.swf", onMessage: Stripe._channelListener }))
                        ...
                        onLoad: function () {
                            return (
                                (this._socketLoadTime = +new Date()),
                                    ...
                                    this._socketAckTime
                                        ? this.loadTimeout
                                        ? (clearTimeout(this.loadTimeout), Stripe._iframeChannelComplete.call(Stripe, !0))
                                        : Stripe.reportError("LoadDelayError", this._socketLoadTime - this._socketAckTime)
                            ...
                            return (
                                (this._socketAckTime = +new Date()),
                                    ...
                                    this.ackTimeout
                                        ...
                                        ? ((this.onLoad = function () {}), Stripe.reportError("AckDelayError", this._socketAckTime - this._socketLoadTime))
